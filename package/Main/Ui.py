...
def MainReloadStyle(self):
    t = self.Theme
    m = open(f'{self.Path}/assets/CSS/MainMain.css').read()
    c = open(f'{self.Path}/assets/CSS/Main{t}.css').read()
    self.setStyleSheet(m+c)
    self.NavSettingsB.setIcon(QIcon(LoadSvg(f'{self.Path}/assets/ICON/Settings{t}.svg', 256, 256)))
    self.NavSettingsB.setIconSize(self.NavSettingsB.size())
    self.NavLogoutB.setIcon(QIcon(LoadSvg(f'{self.Path}/assets/ICON/Exit{t}.svg', 256, 256)))
    self.NavLogoutB.setIconSize(self.NavLogoutB.size())

def MainRetranslate(self):
    t = json.load(open(f'{self.Path}/assets/JSON/MainTranslate.json', 'r', encoding='utf-8'))
    l = self.Language
...
def ListPageReloadStyle(self):
    t = self.Theme
    m = open(f'{self.Path}/assets/CSS/MainListMain.css').read()
    c = open(f'{self.Path}/assets/CSS/MainList{self.Theme}.css').read()
    self.OpenedW.setStyleSheet(m+c)

def ListPageRetranslate(self):
    t = json.load(open(f'{self.Path}/assets/JSON/MainListTranslate.json', 'r', encoding='utf-8'))
    l = self.Language
...
def ListAddPageReloadStyle(self):
    t = self.Theme
    m = open(f'{self.Path}/assets/CSS/MainListAddMain.css').read()
    c = open(f'{self.Path}/assets/CSS/MainListAdd{self.Theme}.css').read()
    self.OpenedW.setStyleSheet(m+c)

def ListAddPageRetranslate(self):
    t = json.load(open(f'{self.Path}/assets/JSON/MainListAddTranslate.json', 'r', encoding='utf-8'))
    l = self.Language
...
def ListSearchPageReloadStyle(self):
    t = self.Theme
    m = open(f'{self.Path}/assets/CSS/MainListSearchMain.css').read()
    c = open(f'{self.Path}/assets/CSS/MainListSearch{self.Theme}.css').read()
    self.OpenedW.setStyleSheet(m+c)

def ListSearchPageRetranslate(self):
    t = json.load(open(f'{self.Path}/assets/JSON/MainListSearchTranslate.json', 'r', encoding='utf-8'))
    l = self.Language
...
def NewsPageReloadStyle(self):
    t = self.Theme
    m = open(f'{self.Path}/assets/CSS/MainNewsMain.css').read()
    c = open(f'{self.Path}/assets/CSS/MainNews{self.Theme}.css').read()
    self.setStyleSheet(m+c)
