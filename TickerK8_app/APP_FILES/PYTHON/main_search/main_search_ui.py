...
#______________________________________________________________________________________________________________________
    ...
    self.panel_layout.addWidget(self.panel_type_etf_button, 15, 24, 3, 14)
    self.panel_layout.addWidget(self.panel_type_forex_button, 15, 43, 3, 14)
    self.panel_layout.addWidget(self.panel_type_index_button, 15, 62, 3, 14)
    self.panel_layout.addWidget(self.panel_type_country_button, 15, 76, 3, 14)
