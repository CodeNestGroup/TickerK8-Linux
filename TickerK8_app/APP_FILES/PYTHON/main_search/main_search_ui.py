...
#______________________________________________________________________________________________________________________
    ...
    self.panel_layout.addWidget(self.panel_search_lineedit, 5, 30, 5, 40)
    self.panel_layout.addWidget(self.panel_type_stock_button, 15, 5, 3, 14)
    self.panel_layout.addWidget(self.panel_type_etf_button, 15, 20, 3, 14)
    self.panel_layout.addWidget(self.panel_type_forex_button, 15, 35, 3, 14)
    self.panel_layout.addWidget(self.panel_type_index_button, 15, 50, 3, 14)
    self.panel_layout.addWidget(self.panel_type_market_button, 15, 65, 3, 14)
    self.panel_layout.addWidget(self.panel_type_country_button, 15, 80, 3, 14)
