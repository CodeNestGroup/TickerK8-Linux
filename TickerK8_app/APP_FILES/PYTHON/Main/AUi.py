...
def MainUi(self):
    ...
    self.NavDefaultB.setProperty('class', '')
    self.NavSearchB.setProperty('class', '')
    self.NavListObjectB.setProperty('class', '')
    self.NavObjectB.setProperty('class', '')
    self.NavNewsB.setProperty('class', '')
    self.NavSettingsB.setProperty('class', '')
    self.NavLogoutB.setProperty('class', '')
