...
#______________________________________________________________________________________________________________________
    ...
    self.register_name_combobox.setProperty('class', 'register_drop_down_list')
...
#______________________________________________________________________________________________________________________
    ...
    self.register_layout.addWidget(self.register_name_combobox, 25, 51, 2, 44)
    self.register_layout.addWidget(self.register_emial_subtitle_label, 35, 0, 2, 100)
    self.register_layout.addWidget(self.register_emial_lineedit, 38, 5, 2, 45)
    self.register_layout.addWidget(self.register_emial_confirm_lineedit, 44, 5, 2, 45)
    ...
    self.register_layout.addWidget(self.register_password_show_button, 74, 77, 2, 18)
    self.register_layout.addWidget(self.register_password_confirm_lineedit, 80, 5, 2, 40)
    self.register_layout.addWidget(self.register_password_confirm_show_button, 80, 77, 2, 18)
...
def register_retranslate(self):
    ...
    self.register_password_confirm_show_button.setText(_t['register_password_confirm_show_button'][_l][1])
