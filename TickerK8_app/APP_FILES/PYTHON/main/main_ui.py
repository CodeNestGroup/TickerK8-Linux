...
#______________________________________________________________________________________________________________________
    ...
    self.main_layout.addWidget(self.stats_button, 90, 60, 10, 15)
    self.main_layout.addWidget(self.news_widget, 0, 90, 90, 10)
    self.main_layout.addWidget(self.news_market_button, 90, 85, 10, 5)
    self.main_layout.addWidget(self.news_country_button, 90, 90, 10, 5)
...
def main_reload_style(self):
    ...
    self.nav_search_button.setIcon(QIcon(load_svg(str(self.main_path+'/STYLE/IMG/icons/main/search_'+self.global_config['__theme__']+'.svg'), 256, 256)))
    self.nav_search_button.setIconSize(self.nav_search_button.size())
    self.nav_type_list_button.setIcon(QIcon(load_svg(str(self.main_path+'/STYLE/IMG/icons/main/list_'+self.global_config['__theme__']+'.svg'), 256, 256)))
    self.nav_type_list_button.setIconSize(self.nav_type_list_button.size())
    self.nav_data_list_button.setIcon(QIcon(load_svg(str(self.main_path+'/STYLE/IMG/icons/main/edit_table_data_'+self.global_config['__theme__']+'.svg'), 256, 256)))
    self.nav_data_list_button.setIconSize(self.nav_data_list_button.size())
...
def main_retranslate(self):
    ...
    self.nav_search_button.setText(_t['nav_search_button'][_l])
