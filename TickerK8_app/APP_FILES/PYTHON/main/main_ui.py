...
def main_ui(self):
    ...
    self.bottom_center_add_button.setObjectName('bottom_center_add_button')
...
#______________________________________________________________________________________________________________________
    ...
    self.bottom_center_add_button.setProperty('class', 'bottom_button')
...
#______________________________________________________________________________________________________________________
    ...
    self.mid_widget_layout.addWidget(self.mid_object_scroll, 0, 0, 100, 29)
    self.mid_widget_layout.addWidget(self.mid_object_list_widget, 0, 31, 100, 38)
    self.mid_widget_layout.addWidget(self.mid_news_widget, 0, 71, 100, 29)
    ...
    self.bottom_widget_layout.addWidget(self.bottom_center_add_button, 0, 30, 100, 40)
...
#______________________________________________________________________________________________________________________
    ...
    self.bottom_center_add_button.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
...
def main_reload_style(self):
    ...
    self.bottom_center_add_button.setIcon(QIcon(load_svg(str(self.main_path+'/STYLE/IMG/icons/main/add_'+self.global_config['__theme__']+'.svg'), 256, 256)))
    self.bottom_center_add_button.setIconSize(self.bottom_center_add_button.size())
...
def main_retranslate(self):
    ...
    self.bottom_center_add_button.setText(_t['bottom_center_add_button'][_l])
