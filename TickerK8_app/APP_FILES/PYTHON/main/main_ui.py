...
#______________________________________________________________________________________________________________________
    ...
    self.top_search_button.setProperty('class', 'top_button')
...
#______________________________________________________________________________________________________________________
    ...
    self.top_widget_layout.addWidget(self.top_exit_button, 30, 5, 40, 5)
    self.top_widget_layout.addWidget(self.top_window_button, 30, 12, 40, 5)
    self.top_widget_layout.addWidget(self.top_minimize_button, 30, 19, 40, 5)
    self.top_widget_layout.addWidget(self.top_search_button, 20, 40, 60, 20)
    self.top_widget_layout.addWidget(self.top_settings_button, 30, 80, 40, 5)
    ...
    self.bottom_widget_layout.addWidget(self.bottom_left_news_button, 0, 0, 1, 1)
    self.bottom_widget_layout.addWidget(self.bottom_left_chart_button, 0, 1, 1, 1)
    self.bottom_widget_layout.addWidget(self.bottom_left_stats_button, 0, 2, 1, 1)
    self.bottom_widget_layout.addWidget(self.botom_center_add_button, 0, 3, 1, 3)
    self.bottom_widget_layout.addWidget(self.bottom_right_market_button, 0, 6, 1, 1)
    self.bottom_widget_layout.addWidget(self.bottom_right_country_button, 0, 7, 1, 1)
    self.bottom_widget_layout.addWidget(self.bottom_right_world_button, 0, 8, 1, 1)
